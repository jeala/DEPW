...
namespace MathInfection
{
    public class GameplayScreen : GameScreen
    {
        ...
        private Texture2D HUDmenu;
        private Vector2 HUDmenuPos;
                                                       ...
                                                       bool coveredByOtherScreen)
        {
            ...
            shield.PickUpShield(player1, ref hasShield);
            shield.PickUpHealth(player1);
        }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Draw(HUDmenu, HUDmenuPos, Color.White);

            //Hardcoded location of shield field icon, for testing purposes
            spriteBacth.Draw(shieldIconF, new Vector2(100, 100), Color.White);
            spriteBacth.Draw(healthIconF, new Vector2(300, 300), Color.White);
            if (hasShield)
                shield.ModifyShield(spriteBacth, player1);
            spriteBacth.End();
        ...
        private void GameplayInit(bool isNewGame)
        {
            ...
            HUDmenuPos = new Vector2(window.ClientBounds.Width - 210, 0);
            hasShield = false;
        ...
        {
            HUDmenu = content.Load<Texture2D>("HUD");
            ...
            shield = new Shield(shieldIconP, playerSize, healthIconF);
        }
